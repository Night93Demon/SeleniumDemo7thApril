...
public class ActionsDragAndDropExample extends TestRun {
	...
	public void testcase() throws InterruptedException  {
		 ...
		 Thread.sleep(2000);
		 WebElement country = driver.findElement(By.xpath("//*[@id=\"ctl00_ContentPlaceholder1_RadTreeView1\"]/ul/li/ul/li[2]/div/div"));
		 WebElement src = driver.findElement(By.xpath("//*[@id=\"ctl00_ContentPlaceholder1_RadTreeView1\"]/ul/li/ul/li[2]/ul/li[1]/div/div"));
